...
from tfops.augment_op import random_crop, random_flip_rl
import tensorflow as tf

slim = tf.contrib.slim

def conv1_32(x, is_training, reuse=False):
    '''
    Args:
    ...
    r = tf.cond(
            is_training, 
            lambda : random_flip_rl(random_crop(tf.pad(x, [[0,0],[4,4],[4,4],[0,0]], "CONSTANT"), 32, 32)),
            lambda : x)
