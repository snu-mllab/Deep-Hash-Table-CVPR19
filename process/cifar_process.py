...
from utils.writer_op import write_npy, create_muldir
from utils.dataset_op import label_count

from configs.path import CIFAR100PATH, CIFARPROCESSED
...
train_image, val_image, train_label, val_label = train_test_split(train_image, train_label, test_size=0.1, random_state=40, stratify=train_label) # Train Val split 9:1
